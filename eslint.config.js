...
export default defineConfig(
	...
	// Original V3Code public-source tooling uses the exact distribution statement
	// enforced by build/hygiene.ts instead of a false Microsoft copyright claim.
	{
		files: [
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'restrictions': [
						...
						'@agentclientprotocol/sdk' // used by agentHost for external agents speaking the Agent Client Protocol
					]
				},
				{
				...
				},
				{
					...
					'restrictions': [
						...
						'vs/editor/contrib/*/~',
						'vs/code/~',
						// V3Code (void): main-process IPC channels + their shared types are
						// registered/wired in app.ts. They live under the workbench contrib but
						// run in (or target) electron-main, so the code layer may import them.
						'vs/workbench/contrib/void/common/**',
						'vs/workbench/contrib/void/electron-main/**',
						'vs/workbench/contrib/computerUse/common/**',
						'vs/workbench/contrib/computerUse/electron-main/**',
						{
							'when': 'hasBrowser',
