...
export interface IAgentWorkspaceWindowSwapOptions {
	readonly workspaceUri?: UriComponents;
	readonly folderUri?: UriComponents;
	readonly sessionUri?: UriComponents;
...
export interface ICommonNativeHostService {
	...
	swapAgentWorkspaceWindow(options: IAgentWorkspaceWindowSwapOptions): Promise<void>;
