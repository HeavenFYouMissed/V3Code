...
export class ClaudeAgentSdkService implements IClaudeAgentSdkService {
	...
	protected async _loadSdk(): Promise<IClaudeSdkBindings> {
		// V3Code bundles the SDK as a production dependency; the starters resolve
		// the bundled copy (or a user-set `chat.agentHost.claudeAgent.path`
		// override) into `AgentHostClaudeSdkPathEnvVar` for this process. Convert
