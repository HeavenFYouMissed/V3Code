...
import { buildClientMcpServers, buildOptions, IDirectHubAuth } from './claudeSdkOptions.js';
...
export interface IMaterializeContext {
	/** Copilot mode: the loopback proxy handle. Omitted in V3Code hub mode. */
	readonly proxyHandle?: IClaudeProxyHandle;
	/** V3Code hub mode: point the SDK straight at the hub's Anthropic passthrough. Omitted in Copilot mode. */
	readonly directHubAuth?: IDirectHubAuth;
