...
/** V3Code: ClaudeAgent injects IProductService for the hub inference base URL. */
const testProductService: IProductService = { _serviceBrand: undefined, ...product, hubApiUrl: 'https://hub.test' };
...
suite('ClaudeAgent', () => {
	...
	test('getProtectedResources returns the GitHub and V3Code hub resources', () => {
		const { agent } = createTestContext(disposables);
