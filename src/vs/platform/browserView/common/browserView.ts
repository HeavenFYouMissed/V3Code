...
export interface IBrowserViewService {
	...
	/**
	 * Run a snippet of JavaScript in the page's isolated world (shared DOM, separate JS context)
	 * and return its result. Used by Visual Edit to inject its in-page panel and apply live edits.
	 */
	executeScript(id: string, code: string): Promise<unknown>;
