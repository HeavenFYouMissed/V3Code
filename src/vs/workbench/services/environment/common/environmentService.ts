...
export interface IWorkbenchEnvironmentService extends IEnvironmentService {
	...
	/**
	 * Whether this window is the dedicated Agent Workspace shell.
	 *
	 * Agent Workspace reuses the ordinary workbench window and editor grid, so
	 * this is the single authoritative signal that lets shared workbench code
	 * avoid treating the shell's editors and layout as ordinary IDE state.
	 */
