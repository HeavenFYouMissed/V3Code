...
export namespace ThemeSettingDefaults {
	export const COLOR_THEME_DARK = 'V3Code Dark';
	export const COLOR_THEME_LIGHT = 'Light 2026';
	export const COLOR_THEME_HC_DARK = 'Default High Contrast';
	export const COLOR_THEME_HC_LIGHT = 'Default High Contrast Light';

	// Matches the `id` contributed by extensions/theme-v3code (SVG icons, MIT
	// Material Icon Theme derived). This is the settings-facing id, not the
	// fully-qualified extension id used by DEFAULT_FILE_ICON_THEME_ID.
	export const FILE_ICON_THEME = 'v3code-minimal';
