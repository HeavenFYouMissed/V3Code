...
// === CHAT SURFACE: INLINE_CHAT ===
// Engine: NATIVE. The in-editor inline chat (Cmd/Ctrl+I over a selection). Distinct surface
// from the sidebar/quick/editor-tab chats; has its own session service
// (inlineChatSessionService). Not the legacy IChatThreadService. See CHAT_SURFACES_MAP.md.
