...
export const HandleDialogBrowserToolData: IToolData = {
	...
	modelDescription: 'Respond to a pending modal or file chooser. With no active modal, arm acceptModal and optional promptText for the next dialog on this page within 30 seconds, then trigger it. Electron pages may not support prompt dialogs.',
