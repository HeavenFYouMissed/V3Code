...
const V3CodeChatButton = Button(localize('gettingStarted.v3codeChat.button', "Open Chat"), 'command:workbench.action.chat.open');
const V3CodeSettingsButton = Button(localize('gettingStarted.v3codeSettings.button', "Open V3Code Settings"), 'command:workbench.action.openVoidSettings');

function createV3CodeAgentStep(): BuiltinGettingStartedStep {
	return {
		id: 'v3codeAgent',
		title: localize('gettingStarted.v3codeAgent.title', "Build with the {0} agent", appName),
		description: localize(
			'gettingStarted.v3codeAgent.description',
			"Describe what you want to build in chat. Use your own API keys today — sign in later for hosted models.\n{0}\n{1}",
			V3CodeChatButton,
			V3CodeSettingsButton,
		),
		when: '!isWeb',
		media: {
			type: 'svg', altText: `${appName} agent`, path: 'multi-file-edits.svg'
		},
	};
}
...
export const walkthroughs: GettingStartedWalkthroughContent = [
	{
		id: 'Setup',
		title: localize('gettingStarted.setup.title', "Get started with {0}", appName),
		description: localize('gettingStarted.setup.description', "Customize your editor, learn the basics, and start coding"),
		isFeatured: true,
		icon: setupIcon,
		when: '!isWeb',
		walkthroughPageTitle: localize('gettingStarted.setup.walkthroughPageTitle', 'Setup {0}', appName),
		next: 'Beginner',
		content: {
			type: 'steps',
			steps: [
				createV3CodeAgentStep(),
				{
					id: 'v3codeOpenProject',
					title: localize('gettingStarted.v3codeOpenProject.title', "Open your project"),
					description: localize('gettingStarted.v3codeOpenProject.description.interpolated', "{0} works on a folder — that's where the index, memory, and code understanding all come from. Open the folder you want to work in first; everything below works on it.\n{1}", appName, Button(localize('gettingStarted.v3codeOpenProject.button', "Open Folder"), 'command:workbench.action.files.openFolder')),
					completionEvents: ['onContext:workspaceFolderCount != 0'],
					media: { type: 'svg', altText: localize('gettingStarted.v3codeOpenProject.altText', "Open a folder in {0}", appName), path: 'openFolder.svg' },
				},
				{
					id: 'v3codeIndexProject',
					title: localize('gettingStarted.v3codeIndex.title', "Index your project"),
					description: localize('gettingStarted.v3codeIndex.description.interpolated', "{0} maps your codebase on your own machine — every symbol, reference, and call graph — so the agent answers from structure, not guesses. It starts automatically; open the status to watch it build.\n{1}", appName, Button(localize('gettingStarted.v3codeIndex.button', "Show Index Status"), 'command:v3code.semanticIndex.showStatus')),
					completionEvents: ['onCommand:v3code.semanticIndex.showStatus'],
					media: { type: 'svg', altText: localize('gettingStarted.v3codeIndex.altText', "{0} semantic index", appName), path: 'search.svg' },
				},
				{
					id: 'v3codeFirstQuestion',
					title: localize('gettingStarted.v3codeAsk.title', "Ask your first question"),
					description: localize('gettingStarted.v3codeAsk.description.interpolated', "Open chat and ask \"What does this project do?\" — the agent answers from the live index and its structural view of your code. That's the difference you feel on turn one.\n{0}", Button(localize('gettingStarted.v3codeAsk.button', "Open Chat"), 'command:workbench.action.chat.open')),
					completionEvents: ['onCommand:workbench.action.chat.open'],
					media: { type: 'svg', altText: localize('gettingStarted.v3codeAsk.altText', "Ask {0}", appName), path: 'ai-powered-suggestions.svg' },
				},
				{
					id: 'v3codeConnectAgent',
					title: localize('gettingStarted.v3codeMcp.title', "Bring your own agent"),
					description: localize('gettingStarted.v3codeMcp.description.interpolated', "{0} also serves its code intelligence over MCP — point Claude Code or any MCP client at your running editor and it borrows the same index, call graphs, and memory. Your brain, their hands.\n{1}", appName, Button(localize('gettingStarted.v3codeMcp.button', "How to connect"), 'https://docs.v3code.dev/connect/other-agents')),
					media: { type: 'svg', altText: localize('gettingStarted.v3codeMcp.altText', "Connect any agent to {0}", appName), path: 'customize-ai.svg' },
				},
				{
					id: 'pickColorTheme',
