...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const header = $('.header', {},
			...
			$('p.subtitle.description', {}, localize({ key: 'gettingStarted.editingEvolved', comment: ['Shown as subtitle on the Welcome page.'] }, "Build with AI agents"))
		);
		...
		if (canShowAgentsBanner(this.chatEntitlementService) && this.productService.applicationName !== 'v3code') {
