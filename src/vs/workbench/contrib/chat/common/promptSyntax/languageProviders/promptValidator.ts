...
const allAttributeNames: Record<PromptsType, string[]> = {
	...
	[PromptsType.skill]: [PromptHeaderAttributes.name, PromptHeaderAttributes.description, PromptHeaderAttributes.license, PromptHeaderAttributes.compatibility, PromptHeaderAttributes.metadata, PromptHeaderAttributes.argumentHint, PromptHeaderAttributes.userInvocable, PromptHeaderAttributes.disableModelInvocation, PromptHeaderAttributes.context, PromptHeaderAttributes.keywords, PromptHeaderAttributes.globs, PromptHeaderAttributes.alwaysApply, PromptHeaderAttributes.loadOnDemand],
