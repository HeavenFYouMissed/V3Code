...
export interface IAgentSkill {
	...
	readonly sessionTypes?: readonly string[];
	/**
	 * Optional keywords matched against the user message to decide skill relevance.
	 */
	readonly keywords?: readonly string[];
	/**
	 * Optional glob patterns matched against attached files to decide skill relevance.
	 */
	readonly globs?: readonly string[];
	/**
	 * When true, the skill is always listed regardless of keyword/glob matches.
	 */
