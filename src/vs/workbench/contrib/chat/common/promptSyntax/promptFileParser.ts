...
export namespace PromptHeaderAttributes {
	...
	export const alwaysApply = 'alwaysApply';
	export const loadOnDemand = 'loadOnDemand';
}
...
export class PromptHeader {
	...
	public get keywords(): string[] | undefined {
		return this.getStringArrayAttribute(PromptHeaderAttributes.keywords);
	}

	public get globs(): string[] | undefined {
		return this.getStringArrayAttribute(PromptHeaderAttributes.globs);
	}

	public get alwaysApply(): boolean | undefined {
		return this.getBooleanAttribute(PromptHeaderAttributes.alwaysApply);
	}

	public get loadOnDemand(): boolean | undefined {
		return this.getBooleanAttribute(PromptHeaderAttributes.loadOnDemand);
	}
