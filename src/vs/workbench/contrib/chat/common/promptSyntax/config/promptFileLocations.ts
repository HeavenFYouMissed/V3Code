...
export const DEFAULT_SKILL_SOURCE_FOLDERS: readonly IPromptSourceFolder[] = [
	{ path: '.v3code/skills', source: PromptFileSource.GitHubWorkspace, storage: PromptsStorage.local },
	...
	{ path: '~/.v3code/skills', source: PromptFileSource.CopilotPersonal, storage: PromptsStorage.user },
...
export const DEFAULT_AGENT_SOURCE_FOLDERS: readonly IPromptSourceFolder[] = [
	...
	{ path: '.v3code/agents', source: PromptFileSource.GitHubWorkspace, storage: PromptsStorage.local },
