...
import { V3CODE_LOCAL_SESSION_ONLY_KEY } from '../../../../void/browser/v3codeDefaultSettings.js';
...
export class SessionTypePickerActionItem extends ChatInputPickerActionViewItem {
	...
	protected _isVisible(type: AgentSessionTarget): boolean {
		if (this.configurationService.getValue<boolean>(V3CODE_LOCAL_SESSION_ONLY_KEY) !== false) {
			return type === AgentSessionProviders.Local;
		}
		return true;
	}
