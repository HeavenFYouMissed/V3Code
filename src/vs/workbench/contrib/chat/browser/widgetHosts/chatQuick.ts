...
// === CHAT SURFACE: QUICK_CHAT ===
// Engine: NATIVE (IChatService / ChatModel). The popup quick-chat. Owns its OWN ephemeral
// session (startNewLocalSession); does NOT adopt the view-pane session — "open in chat view"
// COPIES messages into the view pane's current session. Input renders with isQuickChat=true
// (that's why its text box looks different). See CHAT_SURFACES_MAP.md.
