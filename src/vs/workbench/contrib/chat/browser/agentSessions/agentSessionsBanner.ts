...
/**
 * Creates a banner that promotes V3's chat-first surface.
 * The banner switches the current window into V3 Chat.
 */
export function createAgentsBanner(
	...
	const label = options.label ?? localize('agentsBanner.tryAgentsAppLabel', "Open V3 Chat");
