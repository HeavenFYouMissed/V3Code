...
import { ButtonStop, ButtonSubmit, IconX, VoidChatArea } from '../shared-tsx/chatShared.js';
...
export const QuickEditChat = ({
	...
	const onSubmit = useCallback(async () => {
		...
		// on any failure, re-enable the input so the user can retry or escape (the error itself
		// is surfaced by EditCodeService), and interrupt the stream if it is still linked
