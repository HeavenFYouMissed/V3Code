...
// Types-only module: kept free of heavy imports so the service decorator can be
// resolved without triggering circular-import temporal-dead-zone errors under the
// native ESM loader (toolsService <-> voidCommandBarService cycle).
