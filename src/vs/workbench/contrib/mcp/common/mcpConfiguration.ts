...
export const discoverySourceLabel: Record<DiscoverySource, string> = {
	...
	[DiscoverySource.V3Code]: localize('mcp.discovery.source.v3code', "V3Code"),
};
export const discoverySourceSettingsLabel: Record<DiscoverySource, string> = {
	...
	[DiscoverySource.V3Code]: localize('mcp.discovery.source.v3code.config', "V3Code configuration (`~/.v3code/mcp.json`)"),
};
