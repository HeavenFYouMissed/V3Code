...
import { IAgentWorkspaceWindowSwapOptions, INativeHostOptions, INativeHostService, IOSProperties, IOSStatistics, IToastOptions, IToastResult, PowerSaveBlockerType, SystemIdleState, ThermalState } from '../../../platform/native/common/native.js';
...
export class TestNativeHostService implements INativeHostService {
	...
	async swapAgentWorkspaceWindow(_options: IAgentWorkspaceWindowSwapOptions): Promise<void> { }
