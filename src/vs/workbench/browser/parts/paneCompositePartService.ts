...
import { UnifiedSidebarPart } from './unifiedsidebar/unifiedSidebarPart.js';
...
export class PaneCompositePartService extends Disposable implements IPaneCompositePartService {
	...
	constructor(
		...
		// Registers itself via Part → layoutService.registerPart (not a pane composite).
		instantiationService.createInstance(UnifiedSidebarPart);
