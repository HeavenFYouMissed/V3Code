...
import { V3_PART_LAYOUT_GAP } from '../part.js';
...
export abstract class AbstractPaneCompositePart extends CompositePart<PaneComposite> implements IPaneCompositePart {
	...
	override layout(width: number, height: number, top: number, left: number): void {
		...
		// See Part.applyLayoutGap. One conversion here covers the sidebar, panel, auxiliary bar
		// and unified sidebar, since each delegates to this implementation.
