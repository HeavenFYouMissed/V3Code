...
export class EditorDropTarget extends Themable {
	...
	private onDragEnter(event: DragEvent): void {
		...
		// A file dragged into the Agent Workspace is meant for the prompt, not for an
		// editor group: dropping one used to open it as a pane and eat a slot of the
		// shell. Decline external drops here so the chat's own drop target takes them.
		// Dragging an editor or a group between groups is unaffected - that is a local
		// transfer, not a file drop.
