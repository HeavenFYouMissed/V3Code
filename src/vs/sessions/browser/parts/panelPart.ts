...
export class PanelPart extends AbstractPaneCompositePart {
	...
	/**
	 * Visual margins are zero: the panel sits flush inside the right region
	 * sheet; its top divider is a 1px CSS box-shadow hairline (no layout space).
	 */
	...
	override layout(width: number, height: number, top: number, left: number): void {
		...
		// Margins and borders are zero — the panel fills its grid cell exactly.
		// Its top divider is a CSS box-shadow hairline (no layout space).
