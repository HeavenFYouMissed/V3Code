...
import { isExternalAgentProvider } from '../../../../../platform/agentHost/common/externalAgentCatalogue.js';
...
export const CopilotCLISessionType: ISessionType = {
	id: 'copilotcli',
	label: localize('copilotCLI', "V3Code Agent"),
...
export abstract class BaseAgentHostSessionsProvider extends Disposable implements IAgentHostSessionsProvider {
	...
	private iconForAgentProvider(provider: string): ThemeIcon | undefined {
		// External agents (Agent Client Protocol) are user-supplied; never let a
		// substring match hand them another product's icon.
