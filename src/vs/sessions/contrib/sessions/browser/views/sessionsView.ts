...
export class SessionsView extends ViewPane {
	...
	private createControls(parent: HTMLElement): void {
		...
		// Customizations footer removed — profile stub lives in SidebarFooter.
		// Agent Host toolbar stays for web desktop host picker.
	...
	focusCustomizations(): void {
		// Customizations shortcuts removed from the Agents sidebar.
	}
