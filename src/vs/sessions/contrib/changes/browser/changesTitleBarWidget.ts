...
registerAction2(class extends Action2 {
	...
	run(accessor: ServicesAccessor): void {
		...
		if (isVisible) {
			// The selected diff/file stays on the left while Changes opens
			// as its contained right rail.
			...
			// Closing Changes removes only its rail. The native editor tab
			// strip and selected editor remain in place.
