...
export const unicodeFilter = Object.freeze<string[]>([
	...
	// Vendored design-system reference fixtures (third-party token docs with section/dash chars in comments)
	'!src/vs/workbench/contrib/void/browser/designSystems/**',
]);
...
export const indentationFilter = Object.freeze<string[]>([
	...
	'!extensions/terminal-suggest/src/shell/fishBuiltinsCache.ts',
	'!src/vs/workbench/contrib/browserView/electron-browser/features/browserEditorVisualEditScript.ts',
	'!extensions/terminal-suggest/src/completions/upstream/**',
	'!extensions/typescript-language-features/test-workspace/**',
	...
	// V3Code / void fork — CSS uses mixed tab/space layout (see copyrightFilter exemption)
	'!src/vs/workbench/contrib/void/**',

	// V3Code computer-use native helpers — C++/Swift/RC/XML, not TS conventions. The TypeScript in
	// this contrib is deliberately NOT exempt.
	'!src/vs/workbench/contrib/computerUse/helper/**',

	// V3Code ship-gate scripts (python helpers + pattern lists)
	'!scripts/ip-compliance/**',
]);
...
export const copyrightFilter = Object.freeze<string[]>([
	...
	// V3Code / void fork uses Glass Devtools copyright headers
	'!src/vs/workbench/contrib/void/**',
	'!src/vs/workbench/contrib/computerUse/**',
