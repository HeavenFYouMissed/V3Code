...
function hasAuthenticodeSignature(filePath: string): Promise<boolean> {
	return new Promise(resolve => {
		...
		// Absence of signtool means "not signed", not "cannot continue" — see the
		// identical function in gulpfile.vscode.ts for the full reasoning. Kept in
		// sync deliberately: this copy blocked local REH packaging the same way.
