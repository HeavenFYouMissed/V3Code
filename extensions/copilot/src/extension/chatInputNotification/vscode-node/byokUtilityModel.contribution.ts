...
export class ByokUtilityModelNotificationContribution extends Disposable {
	...
	private async _update(): Promise<void> {
		// V3Code ships v3code/* utility models — never show Copilot's GitHub BYOK setup banner.
		if (this._configService.getNonExtensionConfig<boolean>('v3code.chat.localSessionOnly') !== false) {
