...
suite('modelSupportsExtendedCacheTtl', function () {
	...
	test('is future-proof: matches Opus 4.8, all gen-5+ families (fable/mythos/opus-5), rejects 4.0/4.1 and 3.x', function () {
		expect({
			...
			'claude-opus-4-9': modelSupportsExtendedCacheTtl('claude-opus-4-9'),
			'claude-opus-5': modelSupportsExtendedCacheTtl('claude-opus-5'),
			'claude-sonnet-5': modelSupportsExtendedCacheTtl('claude-sonnet-5'),
			'claude-haiku-5': modelSupportsExtendedCacheTtl('claude-haiku-5'),
			'claude-fable-5': modelSupportsExtendedCacheTtl('claude-fable-5'),
			'claude-mythos-5': modelSupportsExtendedCacheTtl('claude-mythos-5'),
			'claude-fable-5-thinking-max': modelSupportsExtendedCacheTtl('claude-fable-5-thinking-max'),
			'claude-opus-4 (excluded)': modelSupportsExtendedCacheTtl('claude-opus-4'),
			'claude-opus-4-1 (excluded)': modelSupportsExtendedCacheTtl('claude-opus-4-1'),
			'claude-sonnet-4 (excluded)': modelSupportsExtendedCacheTtl('claude-sonnet-4'),
			'claude-3-5-sonnet (excluded)': modelSupportsExtendedCacheTtl('claude-3-5-sonnet-20241022'),
			'claude-3-7-sonnet (excluded)': modelSupportsExtendedCacheTtl('claude-3-7-sonnet'),
		}).toEqual({
			...
			'claude-opus-4 (excluded)': false,
			'claude-opus-4-1 (excluded)': false,
			'claude-sonnet-4 (excluded)': false,
			'claude-3-5-sonnet (excluded)': false,
			'claude-3-7-sonnet (excluded)': false,
		});
	});
